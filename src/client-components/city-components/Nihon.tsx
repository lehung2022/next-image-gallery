...
export default function Nihon() {
  const cityImage02 = { id: "japan_symbol", src: "/other_images/東京.jpg" };
  return (
    <>
      <section className="py-2 px-6 sm:px-12 bg-transparent dark:bg-transparent">
        <div className="flex justify-center items-center py-2">
          <div className="relative w-full h-auto aspect-[4/3] overflow-hidden">
            <Link href="/cities/tokyo" className="relative block w-full h-full">
              <Image
                src={cityImage02.src}
                alt="東京"
                fill
        ...
        <div className="w-full bg-gray-950/50 text-yellow-50 text-lg font-bold text-center p-2 border-2 border-red-600 rounded-lg">
          Tokyo
        </div>
      </section>
    </>
